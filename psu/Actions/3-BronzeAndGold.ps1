...
$chart = New-CustomizedChart -ChartTitle "Bronze and Gold rated PSU" -YAxisTitle "Watt" -XaxisTitle "Hours Since Start"
...
$Chart.SaveImage("Images\BronzeAndGold.png", "png")
Start-Process .\Images\BronzeAndGold.png
